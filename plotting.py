...
adj_by_firstratedata = pd.read_csv(datapath+'adj_by_firstratedata.csv', index_col=0, parse_dates=True)
df_pivot = adj_by_firstratedata.pivot(columns='NAME', values='CLOSE', index='DATE')[futures_tickers]
...
individual_contracts_by_firstratedata = pd.read_csv(datapath+'individual_contracts_by_firstratedata.csv', index_col=0, parse_dates=True)
